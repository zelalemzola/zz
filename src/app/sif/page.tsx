...
export default function Page() {
  ...
  return (
    <div className="flex items-center justify-center h-screen w-full bg-black">
      <main
        className="w-[920px] h-[258px]   rounded-[24px] flex items-center relative overflow-hidden mx-auto -mt-10 shadow-xl border"
        style={{
          background:
            'linear-gradient(180deg, rgba(18,18,18,0.98) 0%, rgba(60,60,60,0.13) 10%, rgba(0,0,0,0.85) 70%, rgba(60,60,60,0.13) 80%, rgba(10,10,10,0.98) 100%)',
          boxShadow:
      ...
      >
        ...
        <div className="pointer-events-none absolute right-0 bottom-0 w-2/3 h-2/3 z-30" style={{
          background:
            'linear-gradient(140deg, rgba(10,10,10,0.85) 60%, rgba(10,10,10,0.98) 100%)',
          filter: 'blur(20px)',
        }} />
        <div className="pointer-events-none  absolute top-[-32px] right-[150px] w-[70px] h-[110px] z-40" style={{
          background:
            'radial-gradient(circle at 60% 40%, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0.08) 60%, transparent 100%)',
          filter: 'blur(22px)',
        }} />
        <div className="pointer-events-none absolute top-[-16px] right-[70px] w-[55px] h-[90px] z-40" style={{
          background:
            'radial-gradient(circle at 40% 40%, rgba(255,255,255,0.16) 0%, rgba(255,255,255,0.07) 60%, transparent 100%)',
          filter: 'blur(18px)',
        }} />
        <div className="pointer-events-none absolute top-[-8px] right-[100px] w-[32px] h-[80px] z-41" style={{
          background:
            'linear-gradient(120deg, rgba(18,18,18,0.98) 0%, rgba(0,0,0,0.85) 100%)',
          filter: 'blur(16px)',
        }} />


<div className="flex-1 pl-7 pt-8">
          ...
          <button
            className="mt-12 py-[6px] px-[22px] rounded-[28px] text-white text-[18px] font-normal cursor-pointer shadow-xl border border-white/30 transition-all duration-150 hover:scale-[1.04] hover:shadow-2xl hover:border-white/50"
            style={{
        ...
        <div
          className="absolute top-1/2 right-8 z-20 flex flex-col items-center justify-center -mt-[4px]"
          style={{
            height: '240px',
            width: '554px',
        ...
        >
          ...
          <div
            key={chats[0].name}
            className="flex items-center justify-between gap-6 rounded-[22px] p-5 shadow-xl h-[73px] backdrop-blur-lg border border-white/30 relative"
            style={{
              width: '554px',
              background:
                'linear-gradient(120deg, rgba(34,34,34,0.96) 60%, rgba(22,22,22,0.92) 100%)',
              zIndex: 3,
              border: '2px solid rgba(120,120,120,0.28)',
              marginBottom: '-18px',
              boxShadow:
                '0 4px 16px 0 rgba(0,0,0,0.22), 0 1.5px 8px 0 rgba(60,60,60,0.10)',
              borderBottom: '2.5px solid rgba(255,255,255,0.28)',
            }}
          >
            ...
            <div className="relative mr-4 w-12 h-12 flex items-center justify-center">
              <Image
                ...
                width={48}
                height={48}
                className="rounded-full object-cover w-[45px] h-[45px] border-[2.5px] border-white shadow-md"
...
<span className="text-[#b1b1b1] ellipsis-hover transition-colors duration-150 hover:text-[#f8f8f8]">
              <EllipsisVertical color="#b1b1b1" fill="#b1b1b1" />
            </span>
          </div>
          {/* Card 2 */}
          <div
            key={chats[1].name}
            className="flex items-center justify-between gap-6 rounded-[22px] p-5 -mt-[8px] shadow-xl h-[73px] backdrop-blur-lg border border-white/30 relative"
            style={{
              width: '523.4px',
              background:
                'linear-gradient(120deg, rgba(34,34,34,0.96) 60%, rgba(22,22,22,0.92) 100%)',
...
<div className="text-left min-w-[140px] ">
          ...
          <div
            key={chats[2].name}
            className="flex items-center justify-between gap-6 -mt-[6px] rounded-[22px] p-5 px-4 shadow-xl h-[73px] backdrop-blur-lg border border-white/30 relative"
            style={{
              width: '478.11px',
              background:
                'linear-gradient(120deg, rgba(34,34,34,0.96) 60%, rgba(22,22,22,0.92) 100%)',
          ...
          >
            ...
            <div className="relative mr-2 mt-1 w-12 h-12 flex items-center justify-center">
              <Image
                src={chats[2].img}
                alt={chats[2].name}
                width={48}
